...
namespace VietnamBusInfo
{
    ...
    sealed partial class App : Application
    {
        ...
        private void RootFrameOnNavigated(object sender, NavigationEventArgs navigationEventArgs)
        {
            ...
            {
                if (navigationEventArgs.SourcePageType != null)
                {
                    string uri = "/" + navigationEventArgs.SourcePageType.FullName;
                    GoogleAnalytics.EasyTracker.GetTracker().SendView(uri);
                }
            }
            else
            {
                GoogleAnalytics.EasyTracker.GetTracker().SendView(navigationEventArgs.Uri.ToString());
            }
        }
